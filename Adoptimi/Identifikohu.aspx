<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Identifikohu.aspx.cs" Inherits="Adoptimi.Identifikohu" %>
        ...
        <div class="div1">
            <table>
                ...
                <tr>
                    ...
                    <td><asp:Button class="button" ID="Button2" onClientClick="location.href='Regjistrim.aspx'" runat="server" Text="Krijo llogari" OnClick="Button2_Click" /></td>
                </tr>
